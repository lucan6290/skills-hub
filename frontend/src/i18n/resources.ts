  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        trayIconTitle: 'System Tray',
        trayIconDesc: 'Show an icon in the system tray for quick access.',
        showTrayIcon: 'Show Tray Icon',
        logLevelTitle: 'Log Level',
        logLevelDesc: 'Control the verbosity of application logs for troubleshooting.',
        logDebug: 'Debug',
        logInfo: 'Info',
        logWarn: 'Warning',
        logError: 'Error',
        autoRefreshTitle: 'Auto Refresh on Startup',
        autoRefreshDesc: 'Automatically scan repositories and update skill data when the app starts.',
        autoRefreshToggle: 'Scan repositories on startup',
      },
      update: {
        title: 'Update',
      ...
      prompts: {
        title: 'Prompt Files',
        subtitle: '{{total}} files tracked, {{exists}} exist on disk',
        scan: 'Scan',
        scanning: 'Scanning...',
        scanDone: 'Scan completed',
        loading: 'Loading...',
        noFiles: 'Click "Scan" to discover prompt files from your installed AI tools.',
        emptyTitle: 'No prompt files yet',
        global: 'Global',
        project: 'Project',
        exists: 'Exists',
        missing: 'Missing',
        ...
        saving: 'Saving...',
        delete: 'Delete',
        deleteConfirm: 'Are you sure you want to delete this prompt file record?',
        unsaved: 'Unsaved',
        fileMissing: 'File does not exist on disk',
        fileMissingHint: 'This file has not been created yet. You can write content and save to create it.',
        editorPlaceholder: 'File content will appear here...',
        loadError: 'Failed to load prompt files',
        scanError: 'Failed to scan prompt files',
        readError: 'Failed to read file content',
      ...
      db: {
        ...
        walCheckpointDesc: 'Merge WAL file into the main database to reduce file count and improve performance.',
        reindex: 'Rebuild Indexes',
        reindexDesc: 'Rebuild all database indexes to fix potential corruption.',
        optimize: 'Optimize Database',
        optimizeDesc: 'Run PRAGMA optimize to let SQLite automatically tune query plans.',
        clearUsage: 'Clear Usage Records',
        clearUsageDesc: 'Delete all skill usage history. This cannot be undone.',
        importBackup: 'Import Backup',
        importBackupDesc: 'Restore database from a backup file. Current database will be backed up first.',
        importBtn: 'Import',
      ...
      toolsPage: {
        ...
        promptSaving: 'Saving...',
        promptDelete: 'Delete',
        promptSaved: 'Prompt file saved',
        promptDeleted: 'Prompt file deleted',
        promptDeleteConfirm: 'Delete prompt file "{{name}}"?',
        promptFileMissing: 'File does not exist on disk',
        promptUnsaved: 'Unsaved changes',
      },
  ...
  zh: {
    translation: {
      ...
      settings: {
        ...
        closeQuit: '退出应用',
        trayIconTitle: '系统托盘',
        trayIconDesc: '在系统托盘中显示图标，方便快速访问。',
        showTrayIcon: '显示托盘图标',
        logLevelTitle: '日志级别',
        logLevelDesc: '控制应用日志的详细程度，用于排查问题。',
        logDebug: '调试',
        logInfo: '信息',
        logWarn: '警告',
        logError: '错误',
        autoRefreshTitle: '启动时自动刷新',
        autoRefreshDesc: '应用启动时自动扫描仓库并更新技能数据。',
        autoRefreshToggle: '启动时扫描仓库',
      },
      update: {
        title: '更新',
        currentVersion: '当前版本',
      ...
      prompts: {
        title: '提示词文件',
        subtitle: '共 {{total}} 个文件，{{exists}} 个存在于磁盘',
        scan: '扫描',
        scanning: '扫描中...',
        scanDone: '扫描完成',
        loading: '加载中...',
        noFiles: '点击「扫描」发现已安装 AI 工具的提示词文件。',
        emptyTitle: '暂无提示词文件',
        global: '全局',
        project: '项目',
        exists: '存在',
        ...
        saving: '保存中...',
        delete: '删除',
        deleteConfirm: '确定要删除此提示词文件记录吗？',
        unsaved: '未保存',
        fileMissing: '文件在磁盘上不存在',
        fileMissingHint: '此文件尚未创建，可以编写内容后保存来创建它。',
        editorPlaceholder: '文件内容将在此显示...',
        loadError: '加载提示词文件失败',
        scanError: '扫描提示词文件失败',
        readError: '读取文件内容失败',
        saveError: '保存文件失败',
      ...
      db: {
        ...
        walCheckpointDesc: '将 WAL 文件合并到主数据库，减少文件数量并提升性能。',
        reindex: '重建索引',
        reindexDesc: '重建所有数据库索引，修复潜在的索引损坏。',
        optimize: '优化数据库',
        optimizeDesc: '执行 PRAGMA optimize，让 SQLite 自动调优查询计划。',
        clearUsage: '清除使用记录',
        clearUsageDesc: '删除所有技能使用历史，此操作不可撤销。',
        importBackup: '导入备份',
        importBackupDesc: '从备份文件恢复数据库，当前数据库会先自动备份。',
        importBtn: '导入',
        exportBackup: '导出备份',
      ...
      toolsPage: {
        ...
        promptSaving: '保存中...',
        promptDelete: '删除',
        promptSaved: '提示词文件已保存',
        promptDeleted: '提示词文件已删除',
        promptDeleteConfirm: '删除提示词文件 "{{name}}"？',
        promptFileMissing: '文件在磁盘上不存在',
        promptUnsaved: '未保存的更改',
      },
