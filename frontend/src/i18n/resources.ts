  ...
  en: {
    translation: {
      ...
      prompts: {
        ...
        scan: 'Scan',
        scanning: 'Scanning...',
        noFiles: 'No prompt files found. Click "Scan" to discover prompt files from installed tools.',
        global: 'Global',
        project: 'Project',
        exists: 'Exists',
        missing: 'Missing',
        ...
        deleteFromDisk: 'Also delete from disk',
        editHint: 'Click a file to view and edit its content',
  ...
  zh: {
    translation: {
      ...
      prompts: {
        ...
        scan: '扫描',
        scanning: '扫描中...',
        noFiles: '未找到提示词文件。点击「扫描」发现已安装工具的提示词文件。',
        global: '全局',
        project: '项目',
        exists: '存在',
        missing: '缺失',
        ...
        deleteFromDisk: '同时从磁盘删除',
        editHint: '点击文件查看和编辑内容',
        loadError: '加载提示词文件失败',
        scanError: '扫描提示词文件失败',
        readError: '读取文件内容失败',
        saveError: '保存文件失败',
